...
object Deck:
  ...
  /** @return
    *   a predefined standard deck starting configuration.
    */
  def getStandardDeck: Deck = {
    val stoat: Card[?] = CreatureCard.empty named "Stoat" withAttack 1 withHealth 2 withSacrificeAttribute Blood(
      1
    ) withRarity Common addSeal Seal.Fledgling addSeal Seal.Sprinter(
      Direction.Right
    ) addSeal Seal.Hefty addSeal Seal.Leader addSeal Seal.BoneKing addSeal Seal.Burrower
  ...
  /** Wraps a list of cards into a Deck.
    ...
    *   The list of cards.
    * @return
    *   a new deck containing the provided cards.
    */
  ...
  extension (deck: Deck)
    ...
    /** Adds a single card to the top of the deck.
      ...
      *   The card to add.
      * @return
      *   a new Deck instance with the added card.
      */
    ...
    /** Removes the specified card from the deck.
      ...
      *   The card to remove.
      * @return
      *   a new Deck instance without the specified card.
      */
    ...
    /** Draws the top card from the deck.
      *
      * @return
      *   an option containing a tuple with the drawn card and the remaining deck, or None if the deck is empty.
      */
    ...
    /** @return
      *   the deck representation as a standard List.
      */
    ...
    /** Draws a specified number of random cards from the deck.
      ...
      * @return
      *   a tuple containing the list of drawn cards and the remaining deck.
      */
    ...
    /** Adds a list of new cards to the top of the deck.
      ...
      *   The cards to add.
      * @return
      *   A new Deck instance containing the added cards.
      */
