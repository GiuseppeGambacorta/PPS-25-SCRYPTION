...
class ViewModelFight(channel: GameMessagesChannel):
  ...
  /** Starts the asynchronous listening of game states to synchronize them with the UI.
    *
    * @param onUpdate
    *   Callback invoked to apply the new game state and the new turn phase to the view.
    */
  ...
  private def processNextEvent(): Unit =
    if eventQueue.isEmpty then isPlayingBack = false
    else
      isPlayingBack = true
  ...
  /** Calculates the total amount of blood generated by the specified sacrifices on the board.
    ...
    * @param sacrificesPositions
    *   The list of coordinates of the cards chosen for sacrifice.
    * @return
    *   The total blood generated.
    */
  ...
  /** Sends a request to play a card on a specific board column.
    ...
    * @param position
    *   The column index where the card will be placed.
    */
  ...
  /** Sends a request to play a card by sacrificing the specified allied creatures.
    ...
    *   The column index where the card will be placed.
    * @param sacrificesPositions
    *   The board coordinates of the sacrificed cards.
    */
  ...
  /** Sends a request to use an item from the inventory.
    *
    * @param item
    *   The game item to use.
    * @param target
    *   The optional board position targeted by the item.
    */
