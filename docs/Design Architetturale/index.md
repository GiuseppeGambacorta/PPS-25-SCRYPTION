...
In questa architettura il Controller ha una responsabilità focalizzata: inizializza le componenti, inietta gli estremi del canale di comunicazione tra il Model e il ViewModel, e gestisce il ciclo principale di esecuzione del gioco (Game Loop).


Il flusso di interazione tra i componenti è illustrato nel seguente diagramma di sequenza:
...
sequenceDiagram
    ...
    CH->>VM: receive() consuma i l messaggio
