...
La quasi totalità dei task pianificati per ogni sprint è stata completata all'interno dello sprint stesso. Il lavoro è stato svolto prevalentemente in modo individuale sui rispettivi task, con alcune parti comuni progettate e realizzate in collaborazione; lo stesso approccio è stato adottato per la stesura della documentazione. All'inizio di ogni iterazione veniva svolta la *sprint review* dello sprint appena concluso, per valutare il lavoro svolto e pianificare di conseguenza le attività successive.
